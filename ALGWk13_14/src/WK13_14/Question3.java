...
//		System.out.print("1 ");
	...
	public static void main (String[] args) {
		Question3.SkipList skipList = new Question3().new SkipList();
		...
		System.out.println("SkipList (Horizontal): ");
		...
		System.out.println("\nLocating Target Key: " + targetKey);
		Question3.SkipListEntry foundEntry = skipList.findEntry(targetKey);
		
		if (foundEntry != null && targetKey.equals(foundEntry.getKey())) {
			System.out.println("Found key " + targetKey + "containing value: " + foundEntry.getValue());
		}else {
			System.out.println("Key " + targetKey + " not found within skip list.");
		}
